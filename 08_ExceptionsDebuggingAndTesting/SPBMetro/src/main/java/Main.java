...
public class Main
{
    ...
    private static Logger loggerStation;
    private static Logger loggerException;

    private static String dataFile = "C:\\Users\\Maxim\\Desktop\\hw_skillbox\\gitlab\\java_basics\\08_ExceptionsDebuggingAndTesting\\SPBMetro\\src\\main\\resources\\map.json";
    ...
    public static void main(String[] args)
    {
        ...
        loggerStation = LogManager.getLogger("search");
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            if(station != null) {
                loggerStation.info("запрос станции: " + station);
                return station;
            }
